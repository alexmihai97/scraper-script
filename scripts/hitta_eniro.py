...
from csv_writer import csv_hitta_eniro
import datetime
reload(sys)
...
if __name__ == "__main__":
    ...
    m_csv_hitta_eniro = csv_hitta_eniro(fname= directory + '/hitta_eniro_result.csv', heading=heading_hitta_eniro)
